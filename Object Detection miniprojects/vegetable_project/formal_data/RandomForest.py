...
def rf_gridsearchcv(csv_path='.\\combined_data2.csv', target_price='배추_가격(원/kg)'):
    ...
    params = {
        ...
        'max_depth': [None, 5, 15],
        'min_samples_leaf': [1, 16, 24],
        'min_samples_split': [2, 16, 24],
        'n_jobs': [-1]
    }
    ...
    df_params.to_csv(f'.\\rf\\{csv_target}_rf_bestparams.csv', encoding='utf-8-sig')
...
if __name__ == '__main__':
    ...
    for i in price_list:
        rf_gridsearchcv(target_price=i)
