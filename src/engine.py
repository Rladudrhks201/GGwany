...
# function for running train iterations
def train(train_data_loader, model):
    print('training ... !')
    global train_itr
    global train_loss_list

    # initialize tqdm process bar
...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if (epoch + 1) % SAVE_PLOTS_EPOCH == 0:
            ...
            val_ax.plot(val_loss, color='green')
        ...
        if (epoch + 1) == NUM_EPOCHS:
            ...
            figure_1.savefig(f'{OUT_DIR}\\train_loss_{epoch + 1}.png')
            figure_2.savefig(f'{OUT_DIR}\\val_loss_{epoch + 1}.png')
            print('SAVING LAST PLOTS COMPLETED')
